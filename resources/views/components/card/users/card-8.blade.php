        ...
        <div class="row">
            ...
            <div class="card">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="container">
                                ...
                                <p>{{ $user->detailadmin->first()->tpt_lhr }},{{ $user->detailadmin->first()->tgl_lhr }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <i class="ni education_hat mr-2"></i>
                        <div class="container">
                            <p>{{ $user->detailadmin->first()->alamat }}</p>
                        </div>
                    </div>
                    </div>
                    <div class="col-md-4">
            ...
            <div class="card card-profile">
                ...
                <div class="d-flex justify-content-center">
                    <a href="{{ route('admin.edit_profil', $user->username) }}" class="btn btn-sm btn-warning mb-0 d-none d-lg-block">Edit Profil</a>
                ...
                <div class="text-center mt-4">
                    <h5>
                        {{ $user->detailadmin->first()->nama }}<span class="font-weight-light">, {{ $user->detailadmin->first()->umur }}</span>
                    </h5>
                    <div class="h6 font-weight-300">
                    <i class="ni location_pin mr-2"></i>{{ $user->detailadmin->first()->tpt_lhr }}, Indonesia
                    </div>
                    <div class="h6 mt-4">
